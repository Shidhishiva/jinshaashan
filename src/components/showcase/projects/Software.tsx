    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                <h2>sidshiva001@gmail.com</h2>
                <br />
                <p>
                    Jinshaashan INFO LLP website, and also the Lorem ipsum dolor
                    sit amet consectetur adipisicing elit. Voluptates, accusamus
                    eius. Quaerat perferendis laborum, non illo blanditiis
                    repellendus ut! Reprehenderit necessitatibus ipsam
                    accusantium iste veniam excepturi deserunt eligendi saepe
                    nemo.
                </p>
                <br />
